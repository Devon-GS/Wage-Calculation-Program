# ==============================================================================
# CASHIER WEEK 1 - ROSTER TIMES TO EXCEL
# ==============================================================================
...
# Get Times
data = pd.read_excel(file, index_col=0, header=4, usecols=columns)
data = data.fillna(0)

# Get Dates
data_date = pd.read_excel(file, header=None, nrows=4, usecols='C:I')
...
def db_cas_init():
    ...
    # Create table
    c.execute(
        """CREATE TABLE IF NOT EXISTS rosterCashierWeekOne (
            name TEXT,
            badge TEXT,
            thur TEXT,
            fri TEXT,
    ...
    query = """INSERT INTO rosterCashierWeekOne (
            name,
            badge,
            thur,
            fri,
...
def db_update_cas_badges():
    # Update table with badge numbers
    con = sqlite3.connect("wageTimes.db")
    c = con.cursor()

    query = """UPDATE rosterCashierWeekOne SET badge = ? WHERE name = ?"""
...
def db_to_excel():
    ...
    for record in name_records:
        ...
        c.execute("SELECT * FROM rosterCashierWeekOne where name=?", (record[0],))
        r = c.fetchall()
...
# ==============================================================================
# CASHIER WEEK 2 - ROSTER TIMES TO EXCEL
# ==============================================================================
# ==============================================================================
# IMPORT ROSTER TIMES AND DATES AND BADGE WEEK 2 (CASHIERS)
# ==============================================================================

# Get Dates
data_date = pd.read_excel(file, header=None, usecols='C:I').loc[12]
...
def db_ctwo_init():
    ...
    # Create table
    c.execute(
        """CREATE TABLE IF NOT EXISTS rosterCashierWeekTwo (
            name TEXT,
            badge TEXT,
            thur TEXT,
            fri TEXT,
    ...
    # Add week one data to table
    week2 = """INSERT INTO rosterCashierWeekTwo (
            name,
            badge,
            thur,
            fri,
...
def db_ctwo_update_badges():
    # Update table with badge numbers
    con = sqlite3.connect("wageTimes.db")
    c = con.cursor()

    query = """UPDATE rosterCashierWeekTwo SET badge = ? WHERE name = ?"""
...
def db_ctwo_to_excel():
    ...
    for record in name_records:
        # Grab data from database using name of person
        c.execute("SELECT * FROM rosterCashierWeekTwo where name=?", (record[0],))
        r = c.fetchall()
